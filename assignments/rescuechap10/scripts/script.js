...
function ans2() {
    heading.style.display = "block";
    answer.textContent = "u cannot tell if an animal has rabies simply by seeing it. A test must be performed to determine if an animal has rabies. Do not approach wildlife that you suspect might be rabid. Contact us to have the animal removed.";
}
...
function ans4() {
    heading.style.display = "block";
    answer.textContent = " need volunteers to help feed animals, care for animals, and clean animal pens. We also accept donations.";
}